...
async def generate_full_report_task(report_id: str) -> None:
    ...
    try:
        ...
        # ── FIX 09A / FIX 09B — ONE GLOBAL_TARGET production spine.
        ...
        try:
            ...
            full.pop("parent_corner", None)
        # INTELLIGENT verification / canonical authority.
...
from carousel_studio import build_carousel_router
...
api_router.include_router(build_dashboard_hub_router(
    db=db, user_dep=get_current_user, admin_dep=get_current_admin,
    email_sender=send_email_async, email_enabled=email_enabled,
))
